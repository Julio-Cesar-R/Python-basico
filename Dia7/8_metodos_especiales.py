...
class CD:
    ...
    def __len__(self):# se define que el largo sera igual a cantidad de canciones cada vez que se solicite mediante una instancia
...
print(mi_cd)# gracias al metodo especial podemos retornar la informacion de la instancia creada __str__
