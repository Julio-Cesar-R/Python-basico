...
class ProbarCambiaTexto(unittest.TestCase):  # importa libreria
    def test_mayuscula(self):  # siempre se define esta funcion como test_algo
        ...
        resultado = unittes_cambia_texto.todo_mayusculas(
            palabra
        )  # el modulo,funcion y la prueba
        self.assertEqual(
            resultado, "Resultado En Mayusculas"
        )  # se hace la comparacion de lo que arroja el metodo con lo que se espera
