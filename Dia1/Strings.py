...
print(palabra.count("al")) #muestra la cantidad de veces que se repite un patron o letra en la cadena
print(f"El caracter se encontro en la posicion {palabra.find('2')}") #posicion del caracter encontrado
print( palabra.upper())
