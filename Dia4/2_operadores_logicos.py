mibool= (4<5) and ("perro"=="perro")#ambas condiciones deben cumplirse para ser true
print(mibool)

mbol=(10==10) or (4==5)# es verddadero siempre que se cumpla una de las dos condiciones
print(mbol)
