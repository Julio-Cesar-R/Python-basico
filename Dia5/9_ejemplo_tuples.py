...
for cafe,precio in informacio_cafe:# dos variables para almacenar las tuplas tambien funciona con diccionarios
    print(precio)
...
cafe,precio= precio_mayor(informacio_cafe)# reasignamos el valor a otras dos variables
