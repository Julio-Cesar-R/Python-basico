...
#tamano de la ventana y ubicacion de aparicion
...
#color de la ventana-----Lista de colores https://es.wikibooks.org/wiki/Python/Interfaz_gr%C3%A1fica_con_Tkinter/Los_nombres_de_los_colores
aplicacion.config(bg="alice blue")

#Panel superior (flat, raised, sunken, groove,ridge)
...
#listra de productos
lista_comidas=["Pollo","Pescado","Cordero", "salmon", "merlusa", "kebap", "pizza", "pasta"]
lista_bebidas=["Agua","Refresco","Vino","Cerveza","Ponche","Jugo","Sidra","Vodka"]
lista_postres=["Helado","Fruta","Brownies","Flan","Muss","Pastel","Chocolate","Galletas"]
...
botones_calculadora=["7","8","9","+","4","5","6","-","1","2","3","X","RE","Borrar","0","/"]
botones_guardados=[]
