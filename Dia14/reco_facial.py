...
cv2.rectangle(
    ...
    (lugar_cara1[1], lugar_cara1[2]),  # cordenadas
    (0, 255, 0),  # Color RGB
    2,
)  # Borde de linea
cv2.rectangle(
    ...
    (lugar_cara2[1], lugar_cara2[2]),  # cordenadas
    (0, 255, 0),  # Color RGB
    2,
)  # Borde de linea
...
resultado = fr.compare_faces(
    [cara_codificada1], cara_codificada2
)  # 0.6)Recibe una lista y una foto y la distancia a aceptara la comparacion
print(resultado)
