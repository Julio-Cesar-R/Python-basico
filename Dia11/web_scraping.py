...
resultado = requests.get(
    "https://escueladirecta-blog.blogspot.com/2022/03/python-pep8-que-es-y-cuales-son-sus.html"
)  # obtener codigo fuente de una pagina web
# print(resultado.text)#mostrarlo con .text
sopa = bs4.BeautifulSoup(
    resultado.text, "lxml"
)  # lo transforma para poder hacer busqueda
