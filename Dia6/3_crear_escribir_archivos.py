archivo = open(
    "prueba.txt", "w"
)  # la "r"= lectura "w"=escritura' reemplaza todo "a"= escribe al dinal de un archivo creado
archivo.write(
    "soy la nueva linea \n"
)  # escribir dentro del archivo, no genera el salto de linea
archivo.write(
    """#soy la segunda nueva linea
esta es la tercera
la cuarta
la quinta
y asi
...
)  # ingresa una lista en una sola linea
archivo.close()


archivo = open(
    "prueba.txt", "a"
)  # no sobrescribe todo el texto agrega en la ultima linea
