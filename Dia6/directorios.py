...
ruta=os.chdir('C:\\Users\\julio\\OneDrive\\Documentos\\Cesar\\Curso python Docs\\Día 6\\Archivos_directorios')
#sirve para ingresar una ruta, no olvidar poner los doble \\ no escribir el nombre del archivo aun

ruta=os.makedirs('C:\\Users\\julio\\OneDrive\\Documentos\\Cesar\\Curso python Docs\\Día 6\\Archivos_directorios\\otra')
#crear directorios
...
os.rmdir('C:\\Users\\julio\\OneDrive\\Documentos\\Cesar\\Curso python Docs\\Día 6\\Archivos_directorios\\otra')
#elimina carpeta de un directorio

ruta=open("C:\\Users\\julio\\OneDrive\\Documentos\\Cesar\\Curso python Docs\\Día 6\\Archivos_directorios\\otro_archivo.txt")
print(ruta.read())
