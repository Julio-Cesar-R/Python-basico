...
print(Counter(" al pan pan y al vino vino".split()))#split sepala el texto por palabras
#/////////////////////////////////////////////////////////////////////////
'''
...
Persona= namedtuple("Persona",["nombre","altura","peso"]) #creamos un objeto de una tupla con namedtuple
...
lista_ciudades=deque(["Londres", "Berlin", "París", "Madrid", "Roma", "Moscú"])#igualacion a la lista
