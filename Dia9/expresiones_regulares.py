...
print(busqueda_numero.group(2))#obtiene solo la busqueda o se define el grupo de busqueda
print("/"*50)
print("/" * 50)

busqueda_total=re.findall(patron_numero,texto_numero)#busqueda de todas las coincidencias (patron, texto)
...
buscar2=re.search(r".mos......",texto1)#los puntos nos muestas los espacios del texto que no se ven
print(buscar2)

buscar3=re.search(r"^\D{5}",texto1)# verifica que la primera posision no sea un numero o cualquier otra
print(buscar3)

buscar4=re.search(r"....\D$",texto1)# verifica que la ultima posision no sea un numero o cualquier otra
print(buscar4)
