...
pantalla=pygame.display.set_mode((800,600))#se crea la pantalla y su tamaño alto y ancho

#Titulo de ventana- FLATICON para descargar iconocs 32 pixeles recomendados
pygame.display.set_caption("INVASION ESPACIAL")
icono=pygame.image.load("C:\\Users\\julio\\OneDrive\\Documentos\\Cesar\\Cursopython\\Python\\Dia10\\Iconos\\ovni.png")
#Asigna icono
pygame.display.set_icon(icono)
fondo=pygame.image.load("C:\\Users\\julio\\OneDrive\\Documentos\\Cesar\\Cursopython\\Python\\Dia10\\Iconos\\fondo.jpg")

#Agregar musica
mixer.music.load("C:\\Users\\julio\\OneDrive\\Documentos\\Cesar\\Cursopython\\Python\\Dia10\\Iconos\\MusicaFondo.mp3")
mixer.music.set_volume(1)#volumen va de o a 1
mixer.music.play(-1)#repetir cada vez que termina

#Jugador
ima_jugador=pygame.image.load("C:\\Users\\julio\\OneDrive\\Documentos\\Cesar\\Cursopython\\Python\\Dia10\\Iconos\\astronave.png")
jugador_x=368
jugador_y=500
jugador_cambioX=0
jugador_cambioy=0
...
for e in range(cantidad_enemigos):
    ima_enemigo.append(pygame.image.load("C:\\Users\\julio\\OneDrive\\Documentos\\Cesar\\Cursopython\\Python\\Dia10\\Iconos\\nave-espacial.png"))
...
#bala
ima_bala=pygame.image.load("C:\\Users\\julio\\OneDrive\\Documentos\\Cesar\\Cursopython\\Python\\Dia10\\Iconos\\bala.png")
bala_x=0
bala_y=500
bala_cambioX=0
bala_cambioy=5
...
#puntaje
puntaje=0
fuente=pygame.font.Font("C:\\Users\\julio\\OneDrive\\Documentos\\Cesar\\Cursopython\\Python\\Dia10\\Iconos\\CollegiateOutlineFLF.ttf",30) #fuente
#Descargar fuentes https://www.1001freefonts.com/
texto_x=10
texto_y=10

#texto final
fuente_final=pygame.font.Font("C:\\Users\\julio\\OneDrive\\Documentos\\Cesar\\Cursopython\\Python\\Dia10\\Iconos\\CollegiateFLF.ttf",40)
...
while se_ejecuta==True:
    ...
    for evento in pygame.event.get():
        ...
        if evento.type==pygame.KEYDOWN:#Presiona boton
            ...
            if evento.key==pygame.K_SPACE:
                #sonido de disparo
                sonido_bala=mixer.Sound("C:\\Users\\julio\\OneDrive\\Documentos\\Cesar\\Cursopython\\Python\\Dia10\\Iconos\\disparo.mp3")
                sonido_bala.play()
                if not bala_visible:
                    bala_x=jugador_x
                    bala(bala_x,bala_y)
    ...
    for e in range(cantidad_enemigos):
        ...
        if colision == True:
            sonido_colision=mixer.Sound("C:\\Users\\julio\\OneDrive\\Documentos\\Cesar\\Cursopython\\Python\\Dia10\\Iconos\\mi_explosion_03_hpx.mp3")
