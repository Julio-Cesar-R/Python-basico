...
print(letras)
print(f" el resultado de la letra {letras[0]} dentro del texto es: {letras[0] in texto}")
print(f" el resultado de la letra {letras[1]} dentro del texto es: {letras[1] in texto}")
print(f" el resultado de la letra {letras[2]} dentro del texto es: {letras[2] in texto}")
