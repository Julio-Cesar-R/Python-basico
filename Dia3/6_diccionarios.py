...
resultado=diccionario['d2']#hace la busqueda de la clave mostrando o almacenando unicamente el valor
print(resultado)
cliente={'nombre':'julio','apellido':'rosas','edad':29,'sueldo':199.7,'habilidades':["programar","administrar","grestionar"]}
